...
def get_shop_category_info(shop_id, proxies=None, verify=None) -> dict:
    ...
    res_obj = requests.get(_url + 'getshopcategoryinfo?' +
                           data, proxies=proxies, verify=verify)
...
def get_foods_by_category(shop_id, category_id, proxies=None, verify=None) -> dict:
    ...
    res_obj = requests.get(_url + 'getfoodsbycategory?' +
                           data, proxies=proxies, verify=verify)
